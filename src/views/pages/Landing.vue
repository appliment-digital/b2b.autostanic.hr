    ...
    <div :class="(menu?.classList.contains('hidden') && menu?.classList.contains('absolute') ? 'h-auto ' : 'overflow-hidden h-screen  md:h-auto ') + 'landing-wrapper'">
                ...
                <div class="logo-section relative w-full md:w-8 mt-6">
                    ...
                    <div class="marquee-wrapper relative overflow-hidden flex gap-6">
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="@public/demo/images/landing/logocloud/alfred-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/bastion-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/charot-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/franki-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/hodly-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/hyper-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/shodan-500.svg" class="h-2rem" alt="" />
                        </div>
                        <div class="marquee flex gap-6" style="animation-duration: 50s">
                            <img src="@public/demo/images/landing/logocloud/alfred-500.svg" class="h-2rem" alt="" />
                            <img src="@public/demo/images/landing/logocloud/bastion-500.svg" class="h-2rem" alt="" />
        ...
        <div ref="customizations" id="customizations" class="landing-section px-4 md:px-8 py-8 mt-8">
            ...
            <div class="video relative" style="max-width: 62rem; margin: 0 auto">
                <img src="@public/demo/images/landing/image-3.png" class="w-full border-round-3xl mb-4" alt="" />
