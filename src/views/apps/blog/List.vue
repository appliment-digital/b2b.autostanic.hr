        ...
        <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
            ...
            <div class="grid nogutter">
                <div class="col-12 lg:col-4 p-4">
                    ...
                    <div class="flex mt-4">
                        <Avatar image="@public/demo/images/avatar/circle/avatar-f-1.png" shape="circle"></Avatar>
                        <div class="ml-2">
                ...
                <div class="col-12 lg:col-4 p-4">
                    ...
                    <div class="font-sm text-700 line-height-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                    <div class="flex mt-4">
                        <Avatar image="@public/demo/images/avatar/circle/avatar-f-2.png" shape="circle"></Avatar>
                        <div class="ml-2">
                ...
                <div class="col-12 lg:col-4 p-4">
                    ...
                    <div class="font-sm text-700 line-height-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                    <div class="flex mt-4">
                        <Avatar image="@public/demo/images/avatar/circle/avatar-f-3.png" shape="circle"></Avatar>
                        <div class="ml-2">
