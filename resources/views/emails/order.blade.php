                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family:'Open Sans', sans-serif, Verdana; font-size:20px; color:#3b3a3a; font-weight:bold; line-height:50px; text-transform:none;" mc:edit="fm-40" valign="top" align="center">
                                                                    <multiline>Narudžba broj:</multiline>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="100%" cellspacing="0" cellpadding="0" border="1" style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#3b3a3a; font-weight:normal; line-height:24px;">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>Slika</th>
                                                                                <th>Proizvod</th>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td>{{ $item->name }}</td>
                                                                                <td><img src="{{ $item->image_url }}" alt="{{ $item->name }}" style="width: 100px; height: auto;" /></td>
                                                                            </tr>
                                                                            @endforeach
                                                                        </tbody>
                                                                    </table>
